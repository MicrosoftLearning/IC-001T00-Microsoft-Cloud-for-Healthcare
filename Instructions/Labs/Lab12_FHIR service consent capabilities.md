...
1.  Go to the FHIR CALLS collection in Postman and click on the POST Consent Resource call.
...
1.  Click **Send** to populate your FHIR service with the Consent Resource.
-   
...
1.  Under **Users** click **None Selected**. Type in your name or Azure login name and press **Select**.

1.  Under **Select a role**, click **None Selected**. Click **Resource Reader**, and then click **Select and Assign**.
...
1.  Under **Users** click **None Selected** (again). Type in your name or Azure login name and press **Select** (again).

1.  Under **Select a role**, click **None Selected** (again). Click **Practitioner**, and then click **Select** and **Assign**.
...
1.  Do a search for yourself and click on your name in the list.
...
1.  Then go to the FHIR CALLS collection and click on the **GET Link Roles** call.
...
1.  You will be prompted to "Authenticate via browser". Click **Proceed**.
...
1.  Then click **Use Token** in the **MANAGE ACCESS TOKENS** window in Postman.
