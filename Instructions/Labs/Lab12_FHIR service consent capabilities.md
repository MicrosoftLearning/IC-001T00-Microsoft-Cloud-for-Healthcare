...
1.  Go to the **FHIR CALLS** collection in **Postman** and click the **POST Consent Resource** call.
...
1.  Click **Resource Reader**, and then click **Select** and **Assign**.
...
1.  Under **Users** click **None Selected** (again). 

1.  Type in your name or Azure login name and press **Select** (again).

1.  Under **Select a role**, click **None Selected** (again). 

1.  Click **Practitioner**, and then click **Select** and **Assign**.
...
1.  Then go to the **FHIR CALLS** collection and click the **GET Link Roles** call.
...
1.  Go to the **FHIR CALLS** collection in Postman and click the **GET Patient Consent Opt Out** call.
