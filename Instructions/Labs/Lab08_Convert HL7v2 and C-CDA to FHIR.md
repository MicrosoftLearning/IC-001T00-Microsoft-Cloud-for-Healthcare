...
### Step 2 - Set up Request Parameters2
...
1.  Click on [ADT_A01.hl7](https://github.com/microsoft/azure-health-data-services-workshop/blob/main/Challenge-02%20-%20Convert%20HL7v2%20and%20C-CDA%20to%20FHIR/samples/ADT_A01.hl7) to view a sample HL7v2 message (you may want to click on the **Raw** button on the right for ease of viewing).
...
1.  Click on [CCDA_Ford_Elaine.xml](https://github.com/microsoft/azure-health-data-services-workshop/blob/main/Challenge-02%20-%20Convert%20HL7v2%20and%20C-CDA%20to%20FHIR/samples/CCDA_Ford_Elaine.xml) to view a sample C-CDA data file (click on Raw on the right side to view the entire data string in your browser window).
...
2.  Select the raw button and choose JSON from the dropdown menu on the right.
3.  Make sure to Save the Convert Data - CCDA request.
...
What does success look like for Lab-02?
