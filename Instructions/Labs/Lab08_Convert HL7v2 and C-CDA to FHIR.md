...
lab:
  ...
  description: In this lab, you will learn how to use the FHIR service's custom \$convert-data operation to convert HL7v2 messages and C-CDA documents into FHIR.
  duration: 60 minutes
  level: 300
  islab: true
---
